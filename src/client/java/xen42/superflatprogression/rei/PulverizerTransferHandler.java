...
public class PulverizerTransferHandler implements SimpleTransferHandler {

	public GrinderScreenHandler getMenu(Context context) {
		if (context.getMenu() instanceof GrinderScreenHandler menu) {
			return menu;
		}
		else {
			return null;
