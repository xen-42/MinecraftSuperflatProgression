...
public class SuperflatProgressionBlockTagGenerator extends BlockTagProvider {
    ...
    protected void configure(WrapperLookup wrapperLookup) {
        ...
        this.getOrCreateTagBuilder(SuperflatProgressionTags.BlockTags.ENRICHED_BONE_MEAL_ON_GRASS)
            ...
            .add(Blocks.LILAC)
            .add(Blocks.PEONY)
            .addOptional(Identifier.of(SuperflatProgression.PEACEFUL_PROGRESSION, "flax_crop"));

        this.getOrCreateTagBuilder(SuperflatProgressionTags.BlockTags.ENRICHED_BONE_MEAL_ON_PODZOL)
            .add(Blocks.GRASS)
            .add(Blocks.TALL_GRASS)
            .add(Blocks.FERN)
