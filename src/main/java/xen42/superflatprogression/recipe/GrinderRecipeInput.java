...
public class GrinderRecipeInput implements RecipeInputInventory {
	private final List<ItemStack> stacks;
	private final RecipeMatcher matcher = new RecipeMatcher();
	private final int stackCount;
	private final GrinderScreenHandler handler;

	private GrinderRecipeInput(GrinderScreenHandler handler, List<ItemStack> stacks) {
	...
	public static GrinderRecipeInput create(GrinderScreenHandler handler, List<ItemStack> stacks) {
		return new GrinderRecipeInput(handler, stacks);
	}
	...
	public boolean equals(Object o) {
		if (o == this) {
			...
			return !(o instanceof GrinderRecipeInput scollCraftingRecipeInput)
				? false
